...
public class Student implements ProtoType<Student> {
	   ...
	   private String name;
		...
		/*
		 * public Student(String yearOfEnrollment, String batchName, String moduleName,
		 * String instructorName, String moduleStartDate, String moduleSchedule, String
		 * moduleEndDate) { this.yearOfEnrollment = yearOfEnrollment; this.batchName =
		 * batchName; this.moduleName = moduleName; this.instructorName =
		 * instructorName; this.moduleStartDate = moduleStartDate; this.moduleSchedule =
		 * moduleSchedule; this.moduleEndDate = moduleEndDate; }
		 */
