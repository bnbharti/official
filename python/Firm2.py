...
print("\nStudent Table Data:")
students_query = "SELEC+T * FROM student;"
...
for student in students:
    student_id = student[0]  # Assuming student[0] is ID
    if student_id in teacher_salary_map:
        new_salary = teacher_salary_map[student_id]
        update_salary_query = f"""
        UPDATE imdb.student
        SET salary = {new_salary}
        WHERE id = {student_id};
        """
        execute_query(imdb_connection, update_salary_query)
